...
class AddListAdapter: ListAdapter<Friend, AddListAdapter.AddListViewHolder>(DiffCallback) {
    ...
    class AddListViewHolder(private val binding: ItemAddFriend2EventHorizontalBinding): RecyclerView.ViewHolder(binding.root){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AddListViewHolder {
        return AddListViewHolder(ItemAddFriend2EventHorizontalBinding
