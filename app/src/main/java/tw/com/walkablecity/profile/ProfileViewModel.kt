...
class ProfileViewModel(val walkableRepository: WalkableRepository) : ViewModel() {
    ...
    val navigateToAddFriend: LiveData<Boolean>
        get() = _navigateToAddFriend

    private val _navigateToExplorer = MutableLiveData<Boolean>(false)
    val navigateToExplorer: LiveData<Boolean>
        get() = _navigateToExplorer
    ...
    val navigateToWalkers: LiveData<Boolean>
        get() = _navigateToWalkers

    private val _navigateToBadge = MutableLiveData<Boolean>(false)
    val navigateToBadge: LiveData<Boolean>
        get() = _navigateToBadge
